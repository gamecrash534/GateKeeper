...
public class WhitelistCommand {
    public static LiteralCommandNode<CommandSource> build() {
        LiteralArgumentBuilder<CommandSource> builder =  BrigadierCommand.literalArgumentBuilder("gatekeeper")
            ...
            .then(AddgroupCommand.build())
            .then(RemovegroupCommand.build())
            .then(ListgroupsCommand.build());
